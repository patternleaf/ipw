	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$('nav#pagination a').on('click', function() {
				...
				$.getJSON(
					'<?php echo ROOT_URL; ?>page/' + page + '/json',
					function(data) {
						loadEntries(data);
						updateCurrentPaginationLink(pageName);
					}
				);
			...
			loadEntries(<?php printJSONEntries(); ?>);
		});
	</script>
